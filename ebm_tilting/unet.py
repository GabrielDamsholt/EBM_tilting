# modified from https://github.com/bot66/MNISTDiffusion/blob/main/unet.py
...
# from https://github.com/lucidrains/denoising-diffusion-pytorch/blob/main/denoising_diffusion_pytorch/denoising_diffusion_pytorch.py#L114
...
class TimeMLP(nn.Module):
    ...
    def __init__(self, embedding_dim, hidden_dim, out_dim):
        super().__init__()
        self.mlp = nn.Sequential(nn.Linear(embedding_dim, hidden_dim), nn.SiLU(), nn.Linear(hidden_dim, out_dim))
        self.act = nn.SiLU()
...
class Unet(nn.Module):
    ...
    def __init__(self, time_embedding_dim, in_channels=1, out_channels=1, base_dim=32, dim_mults: Sequence = [2, 4]):
        super().__init__()
        ...
        self.time_embedding_module = SinusoidalPosEmb(dim=time_embedding_dim)
    ...
    def forward(self, t, x):
        ...
        for decoder_block, shortcut in zip(self.decoder_blocks, encoder_shortcuts, strict=False):
